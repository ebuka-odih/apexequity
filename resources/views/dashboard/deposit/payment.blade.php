                    ...
                    <div class="iq-card-body">
                        ...
                        <form action="" method="post" autocomplete="off" id="withdrawal-form" class="was-validated" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input style="background-color:#131313;" type="file" class="form-control" name="depositProof" accept="image/*" required>
                            </div>
                            <div class="mb-3">
                                <label for="validationTextarea"  style="color:#dbdbdb;">Description</label>
                                <textarea  style="background-color:#131313; color:#dbdbdb;" class="form-control is-invalid" id="validationTextarea" name="narration" placeholder="Narration" required></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary" name="deposit" type="submit">Submit form</button>
                            </div>
                        </form>
                    </div>
                </div>
